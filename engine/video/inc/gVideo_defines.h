...
#define GVIDEO_EMPTY_DATA			-1					//!< Used to avoid the update of specif attribute from a visual element.
...
typedef enum {
	...
	GVIDEO_IMG_FRONT_0 = 1,
	GVIDEO_IMG_FRONT_1 = 2,
	GVIDEO_IMG_FRONT_2 = 3,
	GVIDEO_IMG_FRONT_3 = 4,
	GVIDEO_IMG_LAST_ITEM		//!< Control item of the enum. KEEP IT AS THE LAST!
} en_visual_image_pos;
