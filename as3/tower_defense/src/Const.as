package src
{
	...
	{		
		...
		static const GAME_EVENT_DELAY:Number = 5000; // 5 seconds.
		// Game Event Texts.
		...
		static const MAX_MISSED_WAVE:Number = 5;	//!< Can miss only 5 monster, or its game over.
		
		// Levels.
		static const LEVEL1_MAP_NAME:String = "level1map";
		static const LEVEL1_START_GOLD:Number = 200;
		
		static const LEVEL2_MAP_NAME:String = "level2map";
		static const LEVEL2_START_GOLD:Number = 250;
		
		static const LEVEL3_MAP_NAME:String = "level3map";
		static const LEVEL3_START_GOLD:Number = 300;
		
		static const LEVEL4_MAP_NAME:String = "level4map";
		static const LEVEL4_START_GOLD:Number = 400;
		
		static const LEVEL5_MAP_NAME:String = "level5map";
		static const LEVEL5_START_GOLD:Number = 500;
		
		// Monsters.
		static const SLIME_NAME:String = "Slime";
		static const SLIME_GOLD:Number = 20;
		static const SLIME_SPEED:Number = 1;
		...
		static const WATER_SLIME_GOLD:Number = 40;
		static const WATER_SLIME_SPEED:Number = 2;
		static const WATER_SLIME_LIFE:Number = 30;
		...
		static const EVT_GAME_OVER:String = "game_over";
		...
		static const FIRE_TOWER_RANGE:Number =  Const.TILE_R * 3;
		
		static const FIRE_BULLET:String = "Fire Bullet";
		static const FIRE_BULLET_DMG:Number = 3;
		...
		static const MOON_TOWER_COOLDOWN_MS:Number = 1700;
		static const MOON_TOWER_RANGE:Number =  Const.TILE_R * 3;
		
		static const MOON_BULLET:String = "Moon Bullet";
		static const MOON_BULLET_DMG:Number = 5;
